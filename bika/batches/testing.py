...
class BikaTestLayer(PloneSandboxLayer):
    ...
    def setUpPloneSite(self, portal):
        ...
        applyProfile(portal, 'bika.batches:default')
        ...
        self.request.form['existing'] = "bika.batches:test"
        lsd = LoadSetupData(portal, self.request)
        lsd()

        logout()

NEW_TEST_FIXTURE = BikaTestLayer()

BIKA_NEW_TESTING = FunctionalTesting(
    bases=(NEW_TEST_FIXTURE, z2.ZSERVER_FIXTURE),
    name="AnalyticaTestingLayer:Robot")
